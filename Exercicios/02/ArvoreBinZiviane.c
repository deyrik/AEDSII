...
{  TipoApontador Aux;
  ...
  *p = (*p)->Esq;
  ...
  // se o ponteiro da direita for nulo eu posso so pegar o ponteiro da esquerda 
  // independete porque se a esquerda tbm for nulo continua iqual e se tiver valores
  // a arvore nao fica fora de ordem
